...
class AddBondsCommand : BaseCommand {
    /**
    ...
    override fun runCommand(args: String, context: BaseCommand.CommandContext): BaseCommand.CommandResult {
        ...
        data.bonds = MathUtils.clamp(data.bonds + number, 0f, CommissionData.maxBonds)
        Console.showMessage("Added ${number} requisition bonds for your commission.")
